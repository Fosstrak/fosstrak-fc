...
public class Unsubscribe  implements java.io.Serializable {
    ...
    /**
     * Gets the specName value for this Unsubscribe.
     * 
     * @return specName
     */
    ...
    /**
     * Sets the specName value for this Unsubscribe.
     * 
     * @param specName
     */
    ...
    /**
     * Gets the notificationURI value for this Unsubscribe.
     * 
    ...
    /**
     * Sets the notificationURI value for this Unsubscribe.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:epcglobal:ale:wsdl:1", "Unsubscribe"));
